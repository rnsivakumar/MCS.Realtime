...
namespace MCS.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            if (await _authorizationService.AuthorizeAsync(this.User, id, AuthPolicies.ViewUserByUserIdPolicy) is null)
        ...
        public async Task<IActionResult> GetUserByUserName(string userName)
        {
            ...
            if (await _authorizationService.AuthorizeAsync(this.User, appUser?.Id ?? "", AuthPolicies.ViewUserByUserIdPolicy) is null)
                return new ChallengeResult();
        ...
        public async Task<IActionResult> UpdateUser(string id, [FromBody] UserEditViewModel user)
        {
            ...
            if ((await Task.WhenAll(manageUsersPolicy, assignRolePolicy)).Any(r => r != null))
                return new ChallengeResult();
        ...
        {
            if (await _authorizationService.AuthorizeAsync(this.User, id, AuthPolicies.ManageUserByUserIdPolicy) is null)
                return new ChallengeResult();
        ...
        public async Task<IActionResult> GetRoleById(string id)
        {
            ...
            if (await _authorizationService.AuthorizeAsync(this.User, appRole?.Name ?? "", AuthPolicies.ViewRoleByRoleNamePolicy) is null)
                return new ChallengeResult();
        ...
        {
            if (await _authorizationService.AuthorizeAsync(this.User, name, AuthPolicies.ViewRoleByRoleNamePolicy) is null)
                return new ChallengeResult();
        ...
        {
            //if (await _accountManager.TestCanDeleteRoleAsync(id) is null)
