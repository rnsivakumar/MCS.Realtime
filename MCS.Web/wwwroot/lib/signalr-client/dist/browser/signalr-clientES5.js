...
var HubConnection = function () {
    function HubConnection(connection) {
        var _this = this;
        ...
        value: function connect(url, requestedTransferMode) {
            ...
            return new _promise2.default(function (resolve, reject) {
                ...
                webSocket.onmessage = function (message) {
                    _this.logger.log(ILogger_1.LogLevel.Information, "(WebSockets transport) data received: " + message.data);
                ...
                try {
                    eventSource.onmessage = function (e) {
                        if (_this2.onDataReceived) {
                            try {
                                _this2.logger.log(ILogger_1.LogLevel.Information, "(SSE transport) data received: " + e.data);
                ...
                if (pollXhr.status == 200) {
                    if (_this3.onDataReceived) {
                        try {
                            ...
                            if (response) {
                                _this3.logger.log(ILogger_1.LogLevel.Information, "(LongPolling transport) data received: " + response);
