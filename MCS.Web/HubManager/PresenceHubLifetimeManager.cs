...
namespace MCS.Web
{
        ...
        where THub : HubWithPresence
    {
        ...
        public override async Task OnConnectedAsync(HubConnectionContext connection)
        {
            ...
            _logger.LogCritical($"OnConnectedAsync : {connection.ConnectionId }");
            await _userTracker.AddUser(connection, new UserDetails(connection.ConnectionId, connection.User.Identity.Name, 301));
        }
